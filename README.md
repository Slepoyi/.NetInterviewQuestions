...
## Платформа .NET
<details>
    <summary>(J*, M*) Как устроена память в C#</summary>
...
<details>
<summary>(J*, M) Ключевое слово static и его особенности в .NET</summary>
...
### (J*, M) Статический класс vs singleton vs DI singleton
...
### (J, M*) Блокировка на ```this```, ```Type```, ```string```
Блокировка на ```this```:
...
### (J*, M*) Для чего используется ```ValueTask```, в чем отличие от ```Task```
...
### (J, M*) Что такое куки и как они работают
...
### (J*, M) Глаголы HTTP, назначение и особенности
...
### (J, M) DELETE FROM VS TRUNCATE TABLE
...
### (J*, M*, S) Виды архитектуры приложений
